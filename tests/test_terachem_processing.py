...
from protocharge.generator.terachem_processing import process_terachem_outputs
...
def test_process_terachem_outputs_confs(tmp_path: Path) -> None:
    microstate = tmp_path / "HID"
    raw_confs = microstate / "raw_terachem_outputs" / "confs"

    _write(raw_confs / "conf_001" / "nowater.rst7", "RST7\n")
    _write(raw_confs / "conf_001" / "resp.out", "RESP1\n")
    _write(raw_confs / "conf_001" / "scr.nowater" / "esp.xyz", "ESP1\n")
    _write(raw_confs / "conf_002" / "nowater.rst7", "RST7-2\n")
    _write(raw_confs / "conf_002" / "resp.out", "RESP2\n")
    _write(raw_confs / "conf_002" / "scr.nowater.rst7" / "esp.xyz", "ESP2\n")
