...
from biliresp.twostepresp_frozen_buckets.tsresp import (
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        help="Output NPZ path (default: results/<microstate>/twostepRESP_frozen_buckets/charges_constraint.npz).",
    )
    parser.add_argument(
        "--bucket-file",
        type=Path,
