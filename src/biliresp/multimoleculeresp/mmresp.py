...
from biliresp.multiconfresp.mcresp import _project_root
from biliresp.paths import microstate_config_root, microstate_results_root, results_root
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    for spec in specs:
        ...
        if spec.group_constraint_path and spec.group_constraint_path.is_file():
            ...
            from biliresp.twostepresp_masked_total.tsresp import load_total_constraint  # local import to avoid cycle issues
