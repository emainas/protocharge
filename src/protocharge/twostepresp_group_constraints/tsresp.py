...
def main() -> None:
    parser = argparse.ArgumentParser(description="Two-step RESP (mask-aware group constraints by index)")
    ...
    if logger_step1 and plt is not None:
        ...
        plot_path = (
            ensure_results_dir(args.microstate, "twostepRESP_group_constraints")
            / "resp_step1_loss.png"
        )
